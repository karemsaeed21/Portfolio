...
export const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    // Pills appear 400ms after page load, independent of typewriter animation
  ...
  // Lag-free mouse tracking using requestAnimationFrame + CSS Custom Properties
    ...
    <section id="hero" className="relative z-[1] w-full h-screen flex flex-col justify-end pb-12 md:justify-center md:pb-0 px-5 sm:px-8 md:px-10 overflow-hidden">
      ...
      <div className="max-w-xl relative z-10">
        ...
        >
          ...
          <div
            className="pointer-events-none select-none text-black"
            style={{
              filter: 'blur(4px)',
          ...
          <div
            className="absolute inset-0 pointer-events-none select-none text-black font-medium"
            style={{
              filter: 'blur(0px)',
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 bg-white text-black border border-black/10 rounded-full text-[13px] sm:text-[15px] px-4 sm:px-5 py-[0.3em] mx-[0.2em] mb-[0.4em] whitespace-nowrap hover:bg-black hover:text-white transition-colors duration-200 cursor-pointer shadow-sm active:scale-95"
          >
          ...
          {/* White Pill 3: LinkedIn */}
          <a
            href="www.linkedin.com/in/kareem-mohamed-4ac"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-1.5 bg-white text-black border border-black/10 rounded-full text-[13px] sm:text-[15px] px-4 sm:px-5 py-[0.3em] mx-[0.2em] mb-[0.4em] whitespace-nowrap hover:bg-black hover:text-white transition-colors duration-200 cursor-pointer shadow-sm active:scale-95"
          >
          ...
          >
            ...
            {!copied && (
              <svg
                ...
                className="shrink-0 stroke-current text-white group-hover:text-black transition-colors duration-200"
              >
